...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const root = document.querySelector('.pes-site') || document.body
            ...
            <div>
              <div className="logo" style={{ marginBottom: 20 }}>
                ...
                <div>
                  ...
                  <div className="logo-tagline" style={{ color: 'rgba(255,255,255,0.7)' }}>Caldeiraria · Soldagem EPS</div>
                </div>
              </div>
